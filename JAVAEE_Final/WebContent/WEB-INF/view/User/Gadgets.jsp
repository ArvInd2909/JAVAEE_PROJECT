...
<body>
    <div id="hdr">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            <a href="/television">Television <i class="fa fa-tv"></i></a>
            <a href="/smartPhones">Phone <i class="fa fa-mobile"></i></a>
            <a href="/gadgets">Smart Watch <i class="fa fa-clock-o"></i></a>
            <a href="/laptops">Laptop <i class="fa fa-laptop"></i></a>
          </div>
        ...
        <a href="#Contact">Contact us</a>
            ...
            <a href="/cart" id="rre">Cart <i class="fa fa-1x fa-sign-out"></i></a>	
            </div>
    ...
    <div class="items">
            ...
            <div class="card">
                ...
                <when test="${i.quantity>1}">
                <p><button style="background-color:#1FF4AD;"><a href="updateproduct.html?id=${i.productId}" style="text-decoration: none; color:black">Add to Cart</a></button></p>
                </when>
               <otherwise>
